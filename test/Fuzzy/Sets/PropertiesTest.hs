...
testIsEmpty = do
    let lset = fromList [(1, bot), (2, bot)] :: LSet Int UIGodel
    assertBool "isEmpty function" (isEmpty lset)

testIsSingleton :: Assertion
testIsSingleton = do
    let lset = fromList [(1, bot), (2, top)] :: LSet Int UIGodel
...
testIsUniversal = do
    let lset = fromList [(1, top), (2, top)] :: LSet Int UIGodel
    assertBool "isUniversal function" (isUniversal lset)

testStrictSubsethood :: Assertion
testStrictSubsethood = do
    let lset1 = fromList [(1, top), (2, bot)] :: LSet Int UIGodel
        lset2 = fromList [(1, top), (2, top), (3, 0.5)] :: LSet Int UIGodel
    assertBool "strictSubsethood function" (strictSubsethood lset1 lset2)

testStrictEquality :: Assertion
testStrictEquality = do
    let lset1 = fromList [(1, top), (2, top)] :: LSet Int UIGodel
        lset2 = fromList [(1, top), (2, top)] :: LSet Int UIGodel
...
testGradedSubsethoodGodel = do
    let lset1 = fromList [(1, bot), (2, top)] :: LSet Int UIGodel
        lset2 = fromList [(1, bot), (2, top)] :: LSet Int UIGodel
...
testGradedSubsethoodGodel1 = do
    let lset1 = fromList [(1, 0.3), (2, 0.5)] :: LSet Int UIGodel
        lset2 = fromList [(1, 0.4), (2, 0.6)] :: LSet Int UIGodel
...
testGradedSubsethoodLukasiewicz = do
    let lset1 = fromList [(1, 0.5), (2, 0.5)] :: LSet Int UILukasiewicz
        lset2 = fromList [(1, 0.4), (2, 0.6)] :: LSet Int UILukasiewicz
...
testGradedSubsethoodProduct = do
    let lset1 = fromList [(1, 0.3), (2, 0.5)] :: LSet Int UIProduct
        lset2 = fromList [(1, 0.2), (2, 0.6)] :: LSet Int UIProduct
...
testGradedEqualityGodel1 = do
    let lset1 = fromList [(1, 0.3), (2, 0.5)] :: LSet Int UIGodel
        lset2 = fromList [(1, 0.4), (2, 0.4)] :: LSet Int UIGodel
...
testGradedEqualityLukasiewicz = do
    let lset1 = fromList [(1, 0.2), (2, 0.7)] :: LSet Int UILukasiewicz
        lset2 = fromList [(1, 0.3), (2, 0.4)] :: LSet Int UILukasiewicz
...
testGradedEqualityProduct = do
    let lset1 = fromList [(1, 1), (2, 0.6)] :: LSet Int UIProduct
        lset2 = fromList [(1, 0.9), (2, 0.5)] :: LSet Int UIProduct
